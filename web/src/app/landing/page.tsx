...
export default function LandingPage() {
  return (
    <div className="w-full min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col font-sans selection:bg-emerald-500 selection:text-white">
      {/* Top Navigation Bar - Clean Light Panel */}
      <header className="fixed top-0 left-0 right-0 z-50 h-20 bg-white/90 backdrop-blur-md border-b border-slate-200 px-6 lg:px-12 flex items-center justify-between shadow-xs">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-500 via-teal-500 to-blue-600 p-[1px] shadow-md">
            <div className="w-full h-full bg-white rounded-[11px] flex items-center justify-center">
              <Layers className="w-5 h-5 text-emerald-600" />
            </div>
          </div>
          <div className="flex flex-col">
            <span className="font-heading font-extrabold text-xl tracking-wide text-slate-900 flex items-center gap-1">
              Arkive<span className="text-emerald-600">X</span>
            </span>
            <span className="text-[9px] text-blue-600 uppercase tracking-widest font-extrabold">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2.5 px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold transition-all shadow-md"
          >
            {/* Google SVG Logo */}
          ...
          <Link
            href="/dashboard"
            className="flex items-center gap-2 px-4 py-2 rounded-xl btn-green text-xs shadow-green"
          >
      ...
      {/* Hero Section */}
      <section className="pt-36 pb-20 px-6 lg:px-12 max-w-7xl mx-auto text-center space-y-8 relative overflow-hidden">
        ...
        <div className="absolute top-1/3 right-10 w-96 h-96 bg-blue-500/10 blur-[120px] rounded-full pointer-events-none" />

        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-extrabold shadow-xs">
          <Sparkles className="w-3.5 h-3.5 text-emerald-600 animate-pulse" />
          <span>Next-Generation AI Document Intelligence Platform</span>
        </div>

        {/* Main Headline */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-extrabold text-slate-900 leading-tight max-w-5xl mx-auto tracking-tight">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <button
            onClick={triggerGoogleOAuth}
            className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-sm flex items-center justify-center gap-3 shadow-lg transition-transform hover:scale-105"
          >
          ...
          <Link
            href="/dashboard"
            className="w-full sm:w-auto px-8 py-4 rounded-2xl btn-green text-sm font-extrabold shadow-green flex items-center justify-center gap-2"
          >
        ...
        {/* Live Demo Canvas Card - Light Theme */}
        <div id="demo" className="pt-12">
          <div className="p-6 md:p-8 rounded-3xl bg-white border border-slate-200 text-left max-w-5xl mx-auto shadow-xl relative">
            <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-6">
              ...
              <span className="text-xs font-mono font-bold text-blue-600">SOC2 Type II Certified</span>
            </div>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-900 flex items-center gap-2">
                      <FileText className="w-4 h-4 text-emerald-600" /> Master Vendor Agreement #ACME-2026
                    </span>
      ...
      <section id="features" className="py-20 px-6 lg:px-12 max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            const Icon = m.icon;
            return (
              <div key={idx} className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-3 hover:border-emerald-500 transition-all hover:shadow-md">
                <div className="w-10 h-10 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-emerald-600">
                  <Icon className="w-5 h-5" />
                </div>
                <h3 className="font-heading font-extrabold text-lg text-slate-900">{m.title}</h3>
      ...
      <section id="pricing" className="py-20 px-6 lg:px-12 max-w-7xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h2 className="text-3xl md:text-5xl font-heading font-extrabold text-slate-900">Transparent SaaS Pricing</h2>
          <p className="text-sm text-slate-600 font-medium">Choose managed storage or connect your own S3/R2 infrastructure</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="p-8 rounded-3xl bg-white border border-slate-200 space-y-6 shadow-sm">
            <div>
              ...
              <h3 className="text-3xl font-heading font-extrabold text-slate-900 mt-1">$49 / mo</h3>
              <p className="text-xs text-slate-500 font-medium mt-1">Perfect for growing businesses and professional firms.</p>
            </div>
            <ul className="space-y-3 text-xs text-slate-700 font-medium">
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> Up to 10 Team Members</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> 100 GB Cloudflare R2 Storage</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> Automated OCR & AI Auto-Tagging</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> Approval Workflows & Expiry Radar</li>
            </ul>
            <button onClick={triggerGoogleOAuth} className="w-full py-3.5 rounded-xl btn-green text-xs font-extrabold shadow-green">
              Get Started with Google
            </button>
          </div>

          {/* Enterprise Plan */}
          <div className="p-8 rounded-3xl bg-white border border-emerald-500 space-y-6 shadow-md relative">
            ...
            <div>
              ...
              <h3 className="text-3xl font-heading font-extrabold text-slate-900 mt-1">$199 / mo</h3>
            ...
            <ul className="space-y-3 text-xs text-slate-700 font-medium">
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> Unlimited Team Members & 9 Roles</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> Pluggable Self-Hosted MinIO / AWS S3</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> Dedicated Gemini Reasoning Worker Nodes</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600" /> SOC2 Type II Audit & Immutable Security Logs</li>
            </ul>
